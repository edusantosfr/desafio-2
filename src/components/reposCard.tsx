    ...
    return (
        ...
        <div className="flex flex-col gap-0.6">
            <div className="flex flex-row justify-end items-center gap-5">
                <p className="text-[#6A6F73] font-[500] text-[13px]">de {repos.length}</p>
            ...
            <div className="flex gap-[2vw] overflow-auto w-[84vw] scroll-smooth p-3" ref={carousel}>
                {repos.map((repos) => (
                    <div key={repos.id}>
                        <div className="w-[26vw] h-[280px] rounded-[10px] shadow-[0_0_15px_rgba(0,0,0,0.20)] grid grid-rows-[70px_210px]" >
